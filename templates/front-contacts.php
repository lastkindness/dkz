...
<section class="write-us" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/src/img/backgradient.jpg')">>
    <div class="container">
        <div class="write-us__wrapper">
            ...
            <form class="write-us__inputs">
                <div class="write-us__inputs-title h4">Your Name</div>
                <input type="text" placeholder="Write your email here" class="write-us__inputs-input">
                <div class="write-us__inputs-title h4">Your Phone</div>
                <input type="text" placeholder="Write your email here" class="write-us__inputs-input">
